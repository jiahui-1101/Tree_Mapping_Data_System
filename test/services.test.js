...
import { ROLE } from "../frontend/src/models.js";
import { canAccessPage } from "../frontend/src/services/mockAuthService.js";
import { buildVisitorRoute, maskTreeForRole } from "../frontend/src/services/mockTreeService.js";
import { filterAccessUsers, filterServiceLogs, getServiceLogs } from "../frontend/src/services/itSupportService.js";
import { buildMaintenanceTask, buildUrgentTask, updateTreeRecord } from "../frontend/src/services/adminService.js";
import { analyzeFieldPhoto, buildReportAnalysis, createFieldReport, filterFieldReports, filterRangerTasks, findLinkedTaskForTree } from "../frontend/src/services/rangerService.js";
import { addCollectedTree, addCollectedTreeWithStatus, loadCollection, loadLanguage, saveLanguage } from "../frontend/src/services/storageService.js";
import { TREES } from "../frontend/src/data/trees.js";
import { INITIAL_FIELD_REPORTS } from "../frontend/src/data/fieldReports.js";
import { SERVICE_LOGS, SYSTEM_SERVICES } from "../frontend/src/data/itSupport.js";
import { INITIAL_TASKS } from "../frontend/src/data/tasks.js";
import { visitorText, visitorTreeDescription } from "../frontend/src/services/visitorI18n.js";
import { MAP_ZONES, TBJ_COLLECTION_SUMMARIES, TBJ_MAP_FACTS, TBJ_STAKEHOLDER_PLOTS, countStakeholderRecords, countZoneRecords, formatPlotQuantity, getMapSourceSummary, getStakeholderPlotInventory, getStakeholderPlotsByZone, getStakeholderSourceGroup, getVisitorZone, percentToWorldPosition, worldToPercentPosition } from "../frontend/src/data/gardenMap.js";
import { getPublicTreeCard, projectGrowth } from "../frontend/src/data/visitorTreeProfiles.js";
