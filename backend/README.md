...
The shared MySQL database is `tree_mapping_data_system`. The alert and maintenance task tables use shared names so other backend modules can reuse the same workflow when needed.
...
Current shared tables used by M1-C:
